...
namespace EmployeeComponent
{
    public static class EmployeeCommonOutputText
    {
        ...
        {
            return $"Couldn't find employee with Id({id}). Please press any key to return to the main view...";
        }
        ...
        public static string GetSuccessfulDeletionMessage(int id)
        {
            return $"Record for employee id ({id}) successfully deleted. Press any key to return to main menu...";
        }
    }
}